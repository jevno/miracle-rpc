 ...
 * @ThreadSafe
 */
public class StatusRollingNumber {
    ...
    public StatusRollingNumber(int timeInMilliseconds, int numberOfBuckets) {
        this(ACTUAL_TIME, timeInMilliseconds, numberOfBuckets);
    }

    /* package for testing */ StatusRollingNumber(Time time, int timeInMilliseconds, int numberOfBuckets) {
        this.time = time;
    ...
    /**
     * Increment the counter in the current bucket by one for the given {@link StatusRollingNumberEvent} type.
     * <p>
     * The {@link StatusRollingNumberEvent} must be a "counter" type <code>HystrixRollingNumberEvent.isCounter() == true</code>.
     * 
     * @param type
     *            HystrixRollingNumberEvent defining which counter to increment
     */
    public void increment(StatusRollingNumberEvent type) {
        getCurrentBucket().getAdder(type).increment();
    }

    /**
     * Add to the counter in the current bucket for the given {@link StatusRollingNumberEvent} type.
     * <p>
     * The {@link StatusRollingNumberEvent} must be a "counter" type <code>HystrixRollingNumberEvent.isCounter() == true</code>.
     * 
     * @param type
     ...
     */
    public void add(StatusRollingNumberEvent type, long value) {
     ...
     * <p>
     * The {@link StatusRollingNumberEvent} must be a "max updater" type <code>HystrixRollingNumberEvent.isMaxUpdater() == true</code>.
     * 
     ...
     */
    public void updateRollingMax(StatusRollingNumberEvent type, long value) {
    ...
    /**
     * Get the cumulative sum of all buckets ever since the JVM started without rolling for the given {@link StatusRollingNumberEvent} type.
     * <p>
     * See {@link #getRollingSum(StatusRollingNumberEvent)} for the rolling sum.
     * <p>
     * The {@link StatusRollingNumberEvent} must be a "counter" type <code>HystrixRollingNumberEvent.isCounter() == true</code>.
     * 
     * @param type HystrixRollingNumberEvent defining which counter to retrieve values from
     * @return cumulative sum of all increments and adds for the given {@link StatusRollingNumberEvent} counter type
     */
    public long getCumulativeSum(StatusRollingNumberEvent type) {
    ...
    /**
     * Get the sum of all buckets in the rolling counter for the given {@link StatusRollingNumberEvent} type.
     * <p>
     * The {@link StatusRollingNumberEvent} must be a "counter" type <code>HystrixRollingNumberEvent.isCounter() == true</code>.
     * 
     * @param type
     ...
     * @return
     *         value from the given {@link StatusRollingNumberEvent} counter type
     */
    public long getRollingSum(StatusRollingNumberEvent type) {
    ...
    /**
     * Get the value of the latest (current) bucket in the rolling counter for the given {@link StatusRollingNumberEvent} type.
     * <p>
     * The {@link StatusRollingNumberEvent} must be a "counter" type <code>HystrixRollingNumberEvent.isCounter() == true</code>.
     * 
     * @param type
     ...
     * @return
     *         value from latest bucket for given {@link StatusRollingNumberEvent} counter type
     */
    public long getValueOfLatestBucket(StatusRollingNumberEvent type) {
        Bucket lastBucket = getCurrentBucket();
        if (lastBucket == null)
            return 0;
    ...
    /**
     * Get an array of values for all buckets in the rolling counter for the given {@link StatusRollingNumberEvent} type.
     * <p>
     ...
     * @param type
     *            HystrixRollingNumberEvent defining which counter to retrieve values from
     * @return array of values from each of the rolling buckets for given {@link StatusRollingNumberEvent} counter type
     */
    public long[] getValues(StatusRollingNumberEvent type) {
        Bucket lastBucket = getCurrentBucket();
        if (lastBucket == null)
            return new long[0];
    ...
    /**
     * Get the max value of values in all buckets for the given {@link StatusRollingNumberEvent} type.
     * <p>
     * The {@link StatusRollingNumberEvent} must be a "max updater" type <code>HystrixRollingNumberEvent.isMaxUpdater() == true</code>.
     * 
     * @param type
     *            HystrixRollingNumberEvent defining which "max updater" to retrieve values from
     * @return max value for given {@link StatusRollingNumberEvent} type during rolling window
     */
    public long getRollingMaxValue(StatusRollingNumberEvent type) {
    ...
    /* package */static class Bucket {
        ...
        Bucket(long startTime) {
            ...
            adderForCounterType = new LongAdder[StatusRollingNumberEvent.values().length];
            for (StatusRollingNumberEvent type : StatusRollingNumberEvent.values()) {
                if (type.isCounter()) {
                    adderForCounterType[type.ordinal()] = new LongAdder();
                }
            }

            updaterForCounterType = new LongMaxUpdater[StatusRollingNumberEvent.values().length];
            for (StatusRollingNumberEvent type : StatusRollingNumberEvent.values()) {
        ...
        long get(StatusRollingNumberEvent type) {
            if (type.isCounter()) {
        ...
        LongAdder getAdder(StatusRollingNumberEvent type) {
            if (!type.isCounter()) {
        ...
        LongMaxUpdater getMaxUpdater(StatusRollingNumberEvent type) {
            if (!type.isMaxUpdater()) {
