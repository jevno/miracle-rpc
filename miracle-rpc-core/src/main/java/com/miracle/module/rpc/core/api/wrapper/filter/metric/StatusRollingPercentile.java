 ...
 */
public class StatusRollingPercentile {
    ...
    private static Logger logger = Logger.getLogger(StatusRollingPercentile.class);
    /*
     ...
     */
    public StatusRollingPercentile(int timeInMilliseconds, int numberOfBuckets, int bucketDataLength, boolean enabled) {
        this(ACTUAL_TIME, timeInMilliseconds, numberOfBuckets, bucketDataLength, enabled);

    }

    /* package for testing */ StatusRollingPercentile(Time time, int timeInMilliseconds, int numberOfBuckets, int bucketDataLength, boolean enabled) {
        this.time = time;
